...
- **Supply Run visuals**: updated brief (Marcus, 2026-04-24) — NOT neon/cyberpunk/Blade Runner. Bright saturated **racing colours** (hot orange, racing yellow, red, royal blue), **sunny daylight** on the road, comic-book speed-stripes + POW/ZOOM decals, painted-storybook-dialled-to-11 rather than sci-fi HUD. Same painted-storybook universe as PTV, just kid-fun loud. See [ptv-pet-transport-vehicle.md §Supply Run visual tone](ptv-pet-transport-vehicle.md#supply-run-visual-tone--fun-not-blade-runner-marcus-2026-04-24).
