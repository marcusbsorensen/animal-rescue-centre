...
content = [{
  ...
  'text': (
    ...
    "   - arriving: proportionately-sized comfort object (blanket, pouch, worn toy, crate the animal could fit in); "
    "     NEVER a tiny gift-like box. Dogs specifically should have blankets or worn squeaky toys (not boxes).\n"
    "   - sheltered: NO OBJECTS — just the animal on transparent background.\n"
    "   - eating: a bowl or the animal holding food, never extra scenery.\n"
    "   - sleeping: NO OBJECTS.\n"
    "   - walking: NO OBJECTS (except it's a flying/slithering state for bats/birds/snakes).\n"
