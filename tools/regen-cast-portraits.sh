...
gen "30-two-houses" \
  "A friendly divorced co-parenting family, three full-body figures standing together from head to feet (full length, feet visible). Left: Marcus, 44, Danish man, pale skin, completely bald shaved head, short well-kept dark brown beard that frames a normal visible small friendly closed-lip smile (the mouth and lips are clearly drawn — the beard does not cover or smudge the mouth), warm brown eyes, fitness-focused toned build, black athletic t-shirt and neat joggers, kettlebell silhouette by his foot. Right: Gosia, 42, Polish woman, fair skin, BLONDE hair in a messy top-knot bun, flowered housecoat (dressing gown) over a cosy jumper, slippers. Center (noticeably smaller than the adults, about 3/4 their height): Rhubarb (they/them, only 8 years old, small child), genderqueer androgynous kid with gender-neutral features — definitely NOT feminine-coded. Messy straight windswept surfer-style shoulder-length blonde hair (NOT curly, NOT girly — think skater / surfer kid hair, flat and tousled). Regular neutral blue eyes with normal-size pupils (NOT big sparkly doll eyes, just ordinary kid eyes). Big over-ear headphones around neck, army-camo cargo trousers, a black rock-band t-shirt, beat-up skater Converse, skateboard tucked under one arm. All three smiling, warm co-parenting energy. The parents stand on either side of Rhubarb, not touching each other but both leaning toward the kid. All three stand on the same ground line."
