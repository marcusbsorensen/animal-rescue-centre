...
gen "30-two-houses" \
  "A friendly divorced co-parenting family, three figures standing together for a photo. Left: Marcus, 44, Danish man, pale skin, completely bald shaved head, short well-kept dark beard, fitness-focused toned build, black athletic t-shirt and neat joggers, kettlebell silhouette by his foot. Right: Gosia, 42, Polish woman, fair skin, messy top-knot bun of brown hair, flowered housecoat (dressing gown) over a cosy jumper, slippers. Center: Rhubarb (they/them, 11), genderqueer kid with short messy brown hair, big headphones around neck, army-camo cargo trousers, a black rock-band t-shirt, beat-up skater Converse, skateboard tucked under one arm. All three smiling, warm co-parenting energy. The parents stand on either side of Rhubarb, not touching each other but both leaning toward the kid."
