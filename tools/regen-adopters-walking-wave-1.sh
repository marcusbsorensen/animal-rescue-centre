...
FINN='CHARACTER: Finn O'"'"'Malley — 29, trans man, pale freckled skin, short ginger hair, lean runner'"'"'s build. Wardrobe (IDENTICAL across 3 poses): bright running kit — neon-yellow technical tee, short black running shorts, mud-spattered white trainers, small running watch on left wrist. DOG: an energetic medium brown-and-white dog (collie-mix) at his side in ALL 3 poses — trotting beside him in walking poses, sitting next to his leg in the waving pose. Cheerful athletic expression.'
...
KUMAR_ISHII='CHARACTERS: Kumar-Ishii family of three. Dr. Ishii (she/her, 50, Japanese-British woman, black hair in a low bun, light-teal hospital scrubs with a stethoscope around her neck, white trainers). Priti (she/her, 48, British-Indian woman, warm brown skin, shoulder-length dark hair, soft plum cardigan over a cream blouse, navy trousers, flat brown shoes, a small notebook tucked in her cardigan pocket). Amara (she/her, 9, tomboy daughter, warm brown skin, curly dark hair with a yellow headband, a light-blue short-sleeve tee, olive-green cargo shorts, red low-top sneakers, a couple of leaf fragments caught in her hair and muddy smudges on her knees). Identical wardrobe across all 3 poses. Walk side-by-side; Amara on one side, parents either side of her.'

THEO_GRANDKIDS='CHARACTERS: Grandpa Theo with his two grandchildren. Theo (he/him, 70, Black British man, short grey hair, warm lined face with gentle smile, corduroy trousers in warm tan, a soft olive-green cardigan over a cream shirt, brown leather shoes, an unlit wooden pipe tucked in his cardigan pocket). Kofi (10, warm brown skin, short dark hair, round dark-framed glasses PRESERVED, pale-blue knit jumper, mustard-yellow shorts, white trainers). Zuri (7, warm brown skin, two small puffs of dark curly hair, a coral-pink dress with small white flowers, green leggings, white sneakers, and a butterfly-wings backpack — painted paper-orange-and-black wings strapped to her back). Identical wardrobe across 3 poses. In walking poses, Theo is holding Kofi'"'"'s hand (the nearest grandchild'"'"'s hand).'

BENJI='CHARACTER: Benji Mackenzie — a young solo boy, about 10, pale freckled skin, sandy-brown tousled hair, shy but cheerful expression (small warm smile, not big grin). Wardrobe (IDENTICAL across 3 poses): a forest-green field jacket over a cream tee, brown cargo trousers, sturdy hiking boots, a small canvas satchel over one shoulder (for fox-spotting gear). Body language: a little shy, slightly tucked shoulders, but kind eyes.'

WIRI_HARPER='CHARACTERS: Wiri & Harper — a couple. Wiri Ngata (he/him, Maori man, tall, warm brown skin, short dark hair, a carved green pounamu pendant on a cord around his neck, wearing a park-ranger'"'"'s olive-green coat, khaki trousers, sturdy boots). Harper Stone (they/them, non-binary, slightly shorter than Wiri but still tall, short ash-blonde undercut hair, conservation-biologist vibe, wearing a plaid field shirt in muted blue-and-cream, tan trousers, hiking boots, a metal clipboard ever-present in one hand). Identical wardrobe across 3 poses. Walk side-by-side with Wiri SLIGHTLY TALLER than Harper — preserve this height difference.'
...
ESTRADA='CHARACTERS: The Estrada Train — compact 6-member group composition (do NOT try to cram all 8 kids in, pick 6 members). Polish-Colombian family. Dad Tomasz (38, tall, warm-toned skin, dark brown hair, dark stubble, a dark-red henley, grey jeans, brown boots). Mum Luz (36, also tall, warm-toned skin, glossy dark-brown bob haircut, VISIBLY PREGNANT — noticeable round belly under her clothes in ALL 3 poses, wearing a soft-cream maternity top and dark leggings, flat tan shoes). FOUR KIDS in the composition (choose ages 4, 7, 8-Samuel, 10). ALL kids have the SAME SIGNATURE HAIRCUT — tousled dark-brown curls on top with cleaner shorter sides. Samuel (8) is the boisterous engine of the group, grinning. Other kids in mixed colourful cosy clothes: red jumper, green tee, blue tee, yellow tee. Identical wardrobe across 3 poses. Chaotic-cheerful group energy, parents either end wrangling kids in between.'
